...
static void multiplyQuaternion(const quaternion &a, const quaternion &b,
                               quaternion &result) {
...
static void quaternionToMatrix(float R[3][3]) {
...
void GetOrientation(float *roll, float *pitch, float *yaw) {
  // Standard quaternion-to-Euler (ZYX) extraction.
